...
import { deleteDriverAccount, getDriverOverview } from '~/api/driver'
...
// Успех → выход и экран входа (при следующем заходе снова спросит номер). Отказы
// (смена, долг, деньги, лимит) приходят с сообщением сервера.
