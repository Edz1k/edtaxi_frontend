    ...
    <div class="tg-safe-x pointer-events-none absolute inset-x-0 top-[calc(var(--app-safe-area-top)+0.75rem)] z-10">
      <div class="relative flex justify-center">
        ...
        <RouterLink
          ...
          class="pointer-events-auto absolute right-0 top-0 h-9 flex items-center overflow-hidden rounded-full app-sheet text-xs text-white font-900 shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-[padding,background-color,transform] duration-500 ease-out active:scale-95"
          :class="isBonusHintExpanded ? 'px-3' : 'px-2.25'"
          to="/bonus"
        >
          <span class="i-mdi-star-four-points shrink-0 text-4.5 app-accent drop-shadow-[0_2px_6px_rgba(250,191,38,0.3)]" aria-hidden="true" />
          <span
