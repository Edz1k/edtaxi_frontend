        ...
        >
          <div class="shrink-0 px-5 pb-3 pt-3">
            ...
            <div class="flex items-center justify-between gap-3">
              ...
              <button
                :aria-label="t('prefSheet.closeAria')"
          ...
          <div class="min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 pb-3">
            <div class="rounded-[1.5rem] bg-white/5 p-2 space-y-1">
              ...
              >
                ...
                <span class="min-w-0 flex-1 text-sm text-white font-850">{{ t('prefSheet.childSeat') }}</span>
              ...
              >
                ...
                <span class="min-w-0 flex-1 text-sm text-white font-850">{{ t('prefSheet.pets') }}</span>
              ...
              >
                ...
                <span class="min-w-0 flex-1 text-sm text-white font-850">{{ t('prefSheet.accessible') }}</span>
              </button>
              ...
              >
                ...
                <span class="min-w-0 flex-1 text-sm text-white font-850">{{ t('prefSheet.friendOrder') }}</span>
                <span
              ...
              <div v-if="props.friendOrder" class="px-2.5 pb-2 space-y-2">
                <input
                  ...
                  :aria-label="t('prefSheet.nameAria')"
                  ...
                  maxlength="100"
                  :placeholder="t('prefSheet.namePlaceholder')"
                  type="text"
                  @input="trips.setTripOption('friendName', ($event.target as HTMLInputElement).value)"
                >
                <input
                  :value="trips.tripOptions.friendPhone"
                  :aria-label="t('prefSheet.phoneAria')"
                  class="h-11 w-full rounded-[1.05rem] bg-white/7 px-3.5 text-sm text-white font-800 outline-none transition focus:bg-white/11 placeholder:text-slate-500"
                  inputmode="tel"
                  maxlength="32"
                  :placeholder="t('prefSheet.phonePlaceholder')"
                  type="tel"
            ...
            <textarea
              ...
              :aria-label="t('prefSheet.comment')"
              ...
              maxlength="500"
              :placeholder="t('prefSheet.commentPlaceholder')"
              rows="3"
